...
import { enhance } from '$app/forms';
    ...
    uploadAppointmentPDF = selectedOption === "uploadAppointmentPDF"? true : false;
    useAppointmentEHRAPI = selectedOption === "useAppointmentEHRAPI"? true : false;
  ...
  function handleApiChange(event) {
    ...
    integrateWithCustomAPI = subOption === "integrateWithCustomAPI"? true : false;
    integrateWithFhirAPI = subOption === "integrateWithFhirAPI"? true : false;
  ...
  function handleFrequencyChange(event) {
    ...
    scheduleDaily = selectOp === "scheduleDaily"? true : false;
    scheduleWeekly = selectOp === "scheduleWeekly"? true : false;
    scheduleMonthly = selectOp === "scheduleMonthly"? true : false;
  ...
  function handleMessageFreqChange(event) {
    ...
    hourBefore = selectOption === "hourBefore"? true : false;
    dayBefore = selectOption === "dayBefore"? true : false;
    weekBefore = selectOption === "weekBefore"? true : false;
        ...
        <tbody class="!bg-white dark:!bg-inherit w-full">
            ...
            {#if edit === true}
                ...
                <div class="flex flex-row gap-2 ml-10 sm:ml-16 md:ml-15 lg:ml-24">
                    <input type="radio" id="option1" name="option" value="uploadAppointmentPDF" disabled={edit}/>
                    <label for="option1">Upload Appointment PDF</label>
                </div>
            
                <div class="flex flex-row gap-2 ml-10 sm:ml-16 md:ml-15 lg:ml-24">
                    <input type="radio" id="option2" name="option" value="useAppointmentEHRAPI"  disabled={edit}/>
            ...
            {:else}
                <div class =" flex sm:flex-col flex-col md:flex-col gap-6 lg:flex-row bg-white text-sm ml-0 pb-4 sm:ml-2 md:ml-5 lg:ml-10 mt-2">
                    <div class="flex flex-row gap-2 ml-10 sm:ml-16 md:ml-15 lg:ml-24">
                        <input type="radio" id="option1" name="option" value="uploadAppointmentPDF" bind:group={selectedOption} on:change={handleChange}  />
                        <label for="option1">Upload Appointment PDF</label>
                    </div>
                
                    <div class="flex flex-row gap-2 ml-10 sm:ml-16 md:ml-15 lg:ml-24">
                        <input type="radio" id="option2" name="option" value="useAppointmentEHRAPI" bind:group={selectedOption} on:change={handleChange} />
                        <label for="option2">Use Appointment EHR API</label>
                    </div>
                    </div>
               
                {#if selectedOption === 'useAppointmentEHRAPI'}
                ...
                <div class = "flex sm:flex-col flex-col md:flex-col gap-6 pb-4 bg-white mt-2 lg:flex-row text-sm ml-0 sm:ml-2 md:ml-5 lg:ml-10">
                    ...
                    <div class="flex flex-row gap-2 ml-16 sm:ml-16 md:ml-15 lg:ml-24 ">
                        <input type="radio" id="option3" name="option" value="integrateWithCustomAPI" bind:group={subOption} on:change={handleApiChange} />
                        <label for="option3">Integrate with custom API</label>
                      </div>
                
                      <div class="flex flex-row gap-2 ml-16 sm:ml-16 md:ml-15 lg:ml-24">
                        <input type="radio" id="option4" name="option" value="integrateWithFhirAPI" bind:group={subOption} on:change={handleApiChange} />
                        <label for="option4">Integrate with FHIR API</label>
                      </div>
                    </div>
                
                {#if subOption === 'integrateWithCustomAPI'}
                ...
                {#if subOption === 'integrateWithFhirAPI'}
                <div class = "bg-white pt-2 pr-2 pl-0 sm:pl-2 md:pl-5 lg:pl-10">
                <table class="table mx-auto bg-white">
                    <thead>
                    <tr class="content-left">
                ...
                {#if isScheduleTriggerchecked === true}
                    ...
                    />
                            ...
                            <div class="flex flex-row gap-2 ml-10 sm:ml-16 md:ml-15 lg:ml-24">
                                <input type="radio" id="option6" name="option" value="scheduleDaily" bind:group={selectOp} on:change={handleFrequencyChange} />
                                <label for="option6">Daily</label>
                            </div>
                        
                            <div class="flex flex-row gap-2 ml-10 sm:ml-16 md:ml-15 lg:ml-24">
                                <input type="radio" id="option7" name="option" value="scheduleWeekly" bind:group={selectOp} on:change={handleFrequencyChange}/>
                                <label for="option7">Weekly</label>
                            </div>

                            <div class="flex flex-row gap-2 ml-10 sm:ml-16 md:ml-15 lg:ml-24">
                                <input type="radio" id="option8" name="option" value="scheduleMonthly" bind:group={selectOp} on:change={handleFrequencyChange}/>
                                <label for="option8">Monthly</label>
                            </div>
                        </div>
                        {#if selectOp === 'scheduleWeekly'}
...
<!--                     
                                    ...
                                    <div class="bg-white flex sm:flex-col flex-col md:flex-col lg:flex-row pb-2">
                                        ...
                                        <div class = "bg-white"> 
                                            <div class =" flex sm:flex-col flex-col md:flex-col mt-3 pb-2 gap-6 lg:flex-row bg-white text-sm ml-0 sm:ml-2 md:ml-5 lg:ml-10 ">
                                            <div class="flex flex-row gap-2 ml-10 sm:ml-16 md:ml-15 lg:ml-24">
                                                <input type="radio" id="option1" name="option" value="hourBefore" bind:group={selectOption} on:change={handleMessageFreqChange}/>
                                                <label for="option1">1 Hour before</label>
                                            </div>
                                        
                                            <div class="flex flex-row gap-2 ml-10 sm:ml-16 md:ml-15 lg:ml-24">
                                                <input type="radio" id="option2" name="option" value="dayBefore" bind:group={selectOption} on:change={handleMessageFreqChange}/>
                                                <label for="option2">1 Day before</label>
                                            </div>
                
                                            <div class="flex flex-row gap-2 ml-10 sm:ml-16 md:ml-15 lg:ml-24">
                                                <input type="radio" id="option3" name="option" value="weekBefore" bind:group={selectOption} on:change={handleMessageFreqChange}/>
